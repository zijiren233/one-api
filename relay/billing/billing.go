...
func PostConsumeAmount(ctx context.Context, tokenId int, amount float64, group string, channelId int, modelPrice float64, modelName string, tokenRemark string) {
	...
	model.RecordConsumeLog(ctx, group, channelId, int(amount), 0, modelName, tokenRemark, amount, modelPrice, 0, "")
