...
var ModelRatio = map[string]float64{
	...
	// https://help.aliyun.com/zh/dashscope/developer-reference/sambert-speech-synthesis-metered-billing?spm=a2c4g.11186623.0.0.12a52e5cvlyKYj
	"sambert-zhichu-v1":      0.1 * RMB, // 1 RMB / 10K characters -> 0.1 RMB / 1K characters -> 0.1 RMB / 1K tokens
	"sambert-zhiwei-v1":      0.1 * RMB,
	"sambert-zhixiang-v1":    0.1 * RMB,
	"sambert-zhide-v1":       0.1 * RMB,
	"sambert-zhijia-v1":      0.1 * RMB,
	"sambert-zhinan-v1":      0.1 * RMB,
	"sambert-zhiqi-v1":       0.1 * RMB,
	"sambert-zhiqian-v1":     0.1 * RMB,
	"sambert-zhiru-v1":       0.1 * RMB,
	"sambert-zhimiao-emo-v1": 0.1 * RMB,
	"sambert-zhida-v1":       0.1 * RMB,
	"sambert-zhifei-v1":      0.1 * RMB,
	"sambert-zhigui-v1":      0.1 * RMB,
	"sambert-zhihao-v1":      0.1 * RMB,
	"sambert-zhijing-v1":     0.1 * RMB,
	"sambert-zhilun-v1":      0.1 * RMB,
	"sambert-zhimao-v1":      0.1 * RMB,
	"sambert-zhiming-v1":     0.1 * RMB,
	"sambert-zhimo-v1":       0.1 * RMB,
	"sambert-zhina-v1":       0.1 * RMB,
	"sambert-zhishu-v1":      0.1 * RMB,
	"sambert-zhishuo-v1":     0.1 * RMB,
	"sambert-zhistella-v1":   0.1 * RMB,
	"sambert-zhiting-v1":     0.1 * RMB,
	"sambert-zhixiao-v1":     0.1 * RMB,
	"sambert-zhiya-v1":       0.1 * RMB,
	"sambert-zhiye-v1":       0.1 * RMB,
	"sambert-zhiying-v1":     0.1 * RMB,
	"sambert-zhiyuan-v1":     0.1 * RMB,
	"sambert-zhiyue-v1":      0.1 * RMB,
	"sambert-camila-v1":      0.1 * RMB,
	"sambert-perla-v1":       0.1 * RMB,
	"sambert-indah-v1":       0.1 * RMB,
	"sambert-clara-v1":       0.1 * RMB,
	"sambert-hanna-v1":       0.1 * RMB,
	"sambert-beth-v1":        0.1 * RMB,
	"sambert-betty-v1":       0.1 * RMB,
	"sambert-cally-v1":       0.1 * RMB,
	"sambert-cindy-v1":       0.1 * RMB,
	"sambert-eva-v1":         0.1 * RMB,
	"sambert-donna-v1":       0.1 * RMB,
	"sambert-brian-v1":       0.1 * RMB,
	"sambert-waan-v1":        0.1 * RMB,
